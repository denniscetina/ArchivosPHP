...
$DBname = "discere_db-dev";
 ...
 $id_fellow =$_REQUEST['id_fellow']; //Obtengo el parametro.
 ...
 $query = "SELECT * FROM wait WHERE id_fellow IN (".$id_fellow.")";//HACEMOS LA CONSULTA CON PARAMETRO name POSTERIORMENTE SE CAMBIARA

<?php
//Carga las sesiones pendientes fellow
...
$DBname = "discere_db-dev";
 ...
 $id_user=$_REQUEST['id_user']; //Obtengo el parametro.
 ...
 $query = "SELECT * FROM fellow WHERE user = ('".$id_user."')";//HACEMOS LA CONSULTA CON PARAMETRO name POSTERIORMENTE SE CAMBIARA

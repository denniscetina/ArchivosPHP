...
$tipoActualizado=$_REQUEST["tipoActualizado"]; 
...
$query="UPDATE `lessons` SET `type`='".$tipoActualizado."' WHERE `id_teacher`= '".$id_teacher."' AND id_fellow='".$id_fellow."' "; //se ejecuta el update y devolvemos un 1

...
if(isset($_GET["user"]) && isset($_GET["type"]) && isset($_GET["title"]) && isset($_GET["start"]) && isset($_GET["end"]) && isset($_GET["start_date"]) && isset($_GET["end_date"]) ){
$user=$_GET['user'];
$type=$_GET['type'];
$title=$_GET['title'];
$start=$_GET['start'];
...
$insert="INSERT INTO teacher(user,type,title,start,end,start_date,end_date) VALUES ('{$user}','{$type}','{$title}','{$start}','{$end}','{$start_date}','{$end_date}')";
